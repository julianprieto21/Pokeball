...
export class PlayerSprite implements Sprite {
  ...
  constructor () {
    ...
    this.imagePaths = {
      up: './assets/sprites/player/main/up.png',
      left: './assets/sprites/player/main/left.png',
      down: './assets/sprites/player/main/down.png',
      right: './assets/sprites/player/main/right.png'
    }
    this.width = 0
    this.height = 0
    this.isEnemy = false
